        ...
        <div className="cv-scale">
          ...
          <div className="bg-slate-900 text-white p-6 flex justify-between items-center print:bg-slate-900 print:p-6">
            <div className="flex items-center gap-6">
              <div>
                ...
                <h2 className="text-xl mt-1 text-blue-200 font-medium">
                  Frontend Developer
                </h2>
              </div>
            </div>
            <div className="text-right text-sm space-y-1 text-slate-300">
              <p className="flex items-center justify-end gap-2">
                <FaEnvelope /> abishekadhikari056@gmail.com
              </p>
              <p className="flex items-center justify-end gap-2">
                <FaPhone /> +977 9767377096
              </p>
              <p className="flex items-center justify-end gap-2">
                <FaMapMarkerAlt /> Okhaldhunga-03, Nepal
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-12 min-h-[250mm]">
            ...
            <div className="col-span-4 bg-slate-50 p-6 border-r border-slate-200 print:bg-slate-50">
              ...
              {/* Personal Details */}
              <div className="mb-6">
                <h3 className="text-md font-bold uppercase border-b-2 border-blue-500 pb-1 mb-3 text-slate-900">
                  Personal Details
                </h3>
                <ul className="space-y-2 text-xs text-slate-700">
                  <li className="flex items-center gap-2">
                    <FaCalendar className="text-blue-500" />{" "}
                    <span className="font-semibold">DOB:</span> 2005-12-13
                  </li>
                  <li className="flex items-center gap-2">
              ...
              <div className="mb-6">
                ...
                <div>
                  ...
                  <h4 className="font-bold text-xs text-slate-800 text-wrap leading-tight">
                    Purwanchal Boarding Secondary School
                  </h4>
                  <p className="text-[10px] text-slate-600">
                    SEE / 3.03 GPA | 2024
                  </p>
              ...
              <div className="mb-4">
                ...
                <ul className="space-y-1 text-[10px] text-slate-700">
                  <li className="flex items-center gap-2">
                    <FaGithub className="flex-shrink-0" /> github.com/abishek056
                  </li>
                  <li className="flex items-center gap-2">
            ...
            <div className="col-span-8 p-8">
              {/* Objective */}
              <div className="mb-6">
                <h3 className="text-lg font-bold uppercase border-b-2 border-blue-500 pb-1 mb-3 text-slate-900">
                  Objective
                </h3>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-slate-600">
                      A responsive portfolio featuring dynamic animations and a
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-slate-500 mb-0.5">
                      React, Redux Toolkit, FakeStore API
                    </p>
                    <p className="text-xs text-slate-600">
                      Built a functional shopping cart with product filtering
                      and checkout simulation.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-bold text-slate-800 text-sm">
                    ...
                    <p className="text-xs text-slate-600">
                      Real-time weather application with search and 5-day
